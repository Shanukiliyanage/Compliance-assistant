...
export default function AssessmentIntro() {
  ...
  return (
    <div className="lp">
      ...
      <div className="lp__announce">
        <span className="lp__announceBadge">NEW</span>
        ISO 27001:2022 annex controls now fully covered — 93 controls mapped
        <span className="lp__announceArrow">→</span>
      </div>
